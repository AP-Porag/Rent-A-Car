...
<section id="listing_img_slider">
  <div class="image_box" style="margin-left: 100px;margin-top: 80px;">
      <img src="../uploads/{{$data->carpic}}" class="img-responsive" alt="image" width="900" height="560">
  </div>
        ...
        <div class="sidebar_widget">
          ...
          <form method="post" action="{{route('book')}}">
            ...
            <div class="form-group">
              <input type="hidden" class="form-control" value="{{$data->id}}" name="car_id" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <button class="btn" type="submit" name="send" type="submit">Book </button>
              </div>
          </form>
        </div>
      </aside>
